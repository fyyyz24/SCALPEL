...
def parse_args(args):
    ...
    parser.add_argument(
        "--dataset-type",
        choices=["webdataset", "csv", "synthetic", "auto", "json", "medical_json"],
        default="auto",
    ...
    parser.add_argument(
        ...
        help="Name of the medical dataset to use (mimic_cxr or iu_xray)."
    )
    parser.add_argument(
        "--medical-metadata-path",
        type=str,
        default=None,
        help="Path to pre-extracted ANAO metadata JSON file."
    )
    parser.add_argument(
        "--dataset-type-list",
        type=str,
    ...
    # ANAO (Anatomy-Negation Aware Objective) arguments
    parser.add_argument(
        "--use-anao-loss",
        action="store_true",
        default=False,
        help="Enable Anatomy-Negation Aware Objective loss for medical training."
    )
    parser.add_argument(
        "--anao-anat-weight",
        type=float,
        default=0.1,
        help="Weight for anatomy location penalty in ANAO loss."
    )
    parser.add_argument(
        "--anao-neg-weight",
        type=float,
        default=0.1,
        help="Weight for negation awareness penalty in ANAO loss."
    )
